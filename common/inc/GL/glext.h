...
typedef void (APIENTRYP PFNGLCOLORTABLEPARAMETERFVPROC)(GLenum target, GLenum pname, const GLfloat *paramListGL);
typedef void (APIENTRYP PFNGLCOLORTABLEPARAMETERIVPROC)(GLenum target, GLenum pname, const GLint *paramListGL);
typedef void (APIENTRYP PFNGLCOPYCOLORTABLEPROC)(GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width);
typedef void (APIENTRYP PFNGLGETCOLORTABLEPROC)(GLenum target, GLenum format, GLenum type, GLvoid *table);
typedef void (APIENTRYP PFNGLGETCOLORTABLEPARAMETERFVPROC)(GLenum target, GLenum pname, GLfloat *paramListGL);
typedef void (APIENTRYP PFNGLGETCOLORTABLEPARAMETERIVPROC)(GLenum target, GLenum pname, GLint *paramListGL);
typedef void (APIENTRYP PFNGLCOLORSUBTABLEPROC)(GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const GLvoid *data);
typedef void (APIENTRYP PFNGLCOPYCOLORSUBTABLEPROC)(GLenum target, GLsizei start, GLint x, GLint y, GLsizei width);
typedef void (APIENTRYP PFNGLCONVOLUTIONFILTER1DPROC)(GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *image);
typedef void (APIENTRYP PFNGLCONVOLUTIONFILTER2DPROC)(GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *image);
typedef void (APIENTRYP PFNGLCONVOLUTIONPARAMETERFPROC)(GLenum target, GLenum pname, GLfloat paramListGL);
typedef void (APIENTRYP PFNGLCONVOLUTIONPARAMETERFVPROC)(GLenum target, GLenum pname, const GLfloat *paramListGL);
typedef void (APIENTRYP PFNGLCONVOLUTIONPARAMETERIPROC)(GLenum target, GLenum pname, GLint paramListGL);
typedef void (APIENTRYP PFNGLCONVOLUTIONPARAMETERIVPROC)(GLenum target, GLenum pname, const GLint *paramListGL);
typedef void (APIENTRYP PFNGLCOPYCONVOLUTIONFILTER1DPROC)(GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width);
typedef void (APIENTRYP PFNGLCOPYCONVOLUTIONFILTER2DPROC)(GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height);
typedef void (APIENTRYP PFNGLGETCONVOLUTIONFILTERPROC)(GLenum target, GLenum format, GLenum type, GLvoid *image);
typedef void (APIENTRYP PFNGLGETCONVOLUTIONPARAMETERFVPROC)(GLenum target, GLenum pname, GLfloat *paramListGL);
typedef void (APIENTRYP PFNGLGETCONVOLUTIONPARAMETERIVPROC)(GLenum target, GLenum pname, GLint *paramListGL);
typedef void (APIENTRYP PFNGLGETSEPARABLEFILTERPROC)(GLenum target, GLenum format, GLenum type, GLvoid *row, GLvoid *column, GLvoid *span);
typedef void (APIENTRYP PFNGLSEPARABLEFILTER2DPROC)(GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *row, const GLvoid *column);
typedef void (APIENTRYP PFNGLGETHISTOGRAMPROC)(GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values);
typedef void (APIENTRYP PFNGLGETHISTOGRAMPARAMETERFVPROC)(GLenum target, GLenum pname, GLfloat *paramListGL);
typedef void (APIENTRYP PFNGLGETHISTOGRAMPARAMETERIVPROC)(GLenum target, GLenum pname, GLint *paramListGL);
typedef void (APIENTRYP PFNGLGETMINMAXPROC)(GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values);
typedef void (APIENTRYP PFNGLGETMINMAXPARAMETERFVPROC)(GLenum target, GLenum pname, GLfloat *paramListGL);
typedef void (APIENTRYP PFNGLGETMINMAXPARAMETERIVPROC)(GLenum target, GLenum pname, GLint *paramListGL);
...
#ifdef GL_GLEXT_PROTOTYPES
extern void APIENTRY glGetQueryObjecti64vEXT(GLuint id, GLenum pname, GLint64EXT *paramListGL);
extern void APIENTRY glGetQueryObjectui64vEXT(GLuint id, GLenum pname, GLuint64EXT *paramListGL);
#endif /* GL_GLEXT_PROTOTYPES */
...
#ifdef GL_GLEXT_PROTOTYPES
extern void APIENTRY glTexParameterIivEXT(GLenum target, GLenum pname, const GLint *paramListGL);
extern void APIENTRY glTexParameterIuivEXT(GLenum target, GLenum pname, const GLuint *paramListGL);
extern void APIENTRY glGetTexParameterIivEXT(GLenum target, GLenum pname, GLint *paramListGL);
extern void APIENTRY glGetTexParameterIuivEXT(GLenum target, GLenum pname, GLuint *paramListGL);
...
#ifdef GL_GLEXT_PROTOTYPES
extern void APIENTRY glGetUniformuivEXT(GLuint program, GLint location, GLuint *paramListGL);
...
extern void APIENTRY glGetVertexAttribIivEXT(GLuint index, GLenum pname, GLint *paramListGL);
extern void APIENTRY glGetVertexAttribIuivEXT(GLuint index, GLenum pname, GLuint *paramListGL);
#endif /* GL_GLEXT_PROTOTYPES */
...
extern void APIENTRY glProgramLocalParameterI4ivNV(GLenum target, GLuint index, const GLint *paramListGL);
extern void APIENTRY glProgramLocalParametersI4ivNV(GLenum target, GLuint index, GLsizei count, const GLint *paramListGL);
extern void APIENTRY glProgramLocalParameterI4uiNV(GLenum target, GLuint index, GLuint x, GLuint y, GLuint z, GLuint w);
extern void APIENTRY glProgramLocalParameterI4uivNV(GLenum target, GLuint index, const GLuint *paramListGL);
extern void APIENTRY glProgramLocalParametersI4uivNV(GLenum target, GLuint index, GLsizei count, const GLuint *paramListGL);
extern void APIENTRY glProgramEnvParameterI4iNV(GLenum target, GLuint index, GLint x, GLint y, GLint z, GLint w);
extern void APIENTRY glProgramEnvParameterI4ivNV(GLenum target, GLuint index, const GLint *paramListGL);
extern void APIENTRY glProgramEnvParametersI4ivNV(GLenum target, GLuint index, GLsizei count, const GLint *paramListGL);
extern void APIENTRY glProgramEnvParameterI4uiNV(GLenum target, GLuint index, GLuint x, GLuint y, GLuint z, GLuint w);
extern void APIENTRY glProgramEnvParameterI4uivNV(GLenum target, GLuint index, const GLuint *paramListGL);
extern void APIENTRY glProgramEnvParametersI4uivNV(GLenum target, GLuint index, GLsizei count, const GLuint *paramListGL);
extern void APIENTRY glGetProgramLocalParameterIivNV(GLenum target, GLuint index, GLint *paramListGL);
extern void APIENTRY glGetProgramLocalParameterIuivNV(GLenum target, GLuint index, GLuint *paramListGL);
extern void APIENTRY glGetProgramEnvParameterIivNV(GLenum target, GLuint index, GLint *paramListGL);
extern void APIENTRY glGetProgramEnvParameterIuivNV(GLenum target, GLuint index, GLuint *paramListGL);
#endif /* GL_GLEXT_PROTOTYPES */
...
#ifdef GL_GLEXT_PROTOTYPES
extern void APIENTRY glProgramBufferParametersfvNV(GLenum target, GLuint buffer, GLuint index, GLsizei count, const GLfloat *paramListGL);
extern void APIENTRY glProgramBufferParametersIivNV(GLenum target, GLuint buffer, GLuint index, GLsizei count, const GLint *paramListGL);
extern void APIENTRY glProgramBufferParametersIuivNV(GLenum target, GLuint buffer, GLuint index, GLsizei count, const GLuint *paramListGL);
#endif /* GL_GLEXT_PROTOTYPES */
